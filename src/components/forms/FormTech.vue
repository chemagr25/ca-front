<template>
    <v-form class="pb-8" v-model="form" @submit.prevent>
        ...
        <v-row class=" mt-4">
            ...
            <v-col cols="12" sm="6" md="4">
                <v-text-field clearable persistent-hint hint="Marca del dispositivo"
                    class="shadow bg-gray-100  pb-2 rounded" v-model="lastName" label="apellido"></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="4">
                <v-text-field persistent-hint hint="Modelo del dispositivo" class=" shadow bg-gray-100 pb-2 rounded"
                    v-model="email" label="correo"></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="4">
                <v-text-field persistent-hint hint="S/N" class="shadow bg-gray-100 pb-2 rounded" v-model="password"
            ...
            <v-col cols="12" sm="6" md="4">
                <v-text-field persistent-hint hint="En GB" class="shadow bg-gray-100 pb-2 rounded" v-model="phone"
